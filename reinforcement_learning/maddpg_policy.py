...
class MADDPGPolicy_LocalCritic(object):
...
class MADDPGPolicy_LocalCritic_ParamSharing(object):
    def __init__(self, ob_size, ac_size, n_agent, parameters, evaluation_mode=False):
        ...
        if not evaluation_mode:
            ...
            self.memory = ReplayBufferParamSharing(ac_size, self.buffer_size, self.batch_size, self.device)
...
class MADDPGPolicy_GlobalCritic_ParamSharing(object):
    def __init__(self, ob_size, ac_size, n_agent, parameters, evaluation_mode=False):
        self.evaluation_mode = evaluation_mode

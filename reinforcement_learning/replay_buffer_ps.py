...
agent_id: indicates which agent this experience belongs to
"""
Experience = namedtuple("Experience", field_names=["obs_n", "act_n", "reward", "next_obs_n", "done", "act_mask", "agent_id"])
...
class ReplayBuffer:
    ...
    def add(self, obs_n, act_n, reward, next_obs_n, done, act_mask, agent_id):
        ...
        ======
            ...
            agent_id:   int
        """
        e = Experience(obs_n, act_n, reward, next_obs_n, done, act_mask, agent_id)
